...
class Container_d9301c25cc extends Nette\DI\Container
{
	protected $meta = array(
		'types' => array(
			...
			'App\Presenters\CardsPresenter' => array(array('application.5')),
			'App\Presenters\PostPresenter' => array(array('application.6')),
			'App\Presenters\CardReadersPresenter' => array(array('application.7')),
			'App\Presenters\ErrorPresenter' => array(array('application.8')),
			'App\Presenters\Error4xxPresenter' => array(array('application.9')),
		...
		'services' => array(
			...
			'application.5' => 'App\Presenters\CardsPresenter',
			...
			'application.9' => 'App\Presenters\Error4xxPresenter',
	...
	{
		return new Container_d9301c25cc_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
final class Container_d9301c25cc_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_d9301c25cc $container)
	{
